mpath="/workspace/asr/peft/qlora/models--meta-llama--Llama-2-70b-hf/snapshots/b70e3df5fc2bf95ba5859878cafa2da37908598c"

python qlazylora.py \
    --model_name_or_path $mpath \
    --output_dir ./output/huarizo-llama2-70b-2-hf-orig \
