...
mpath="/workspace/asr/llama/models--meta-llama--Llama-2-70b-chat-hf/snapshots/c733a855493ee517f3c51c490ea6ce6ce52cd837"

python qlazylora.py \
    --model_name_or_path $mpath \
    --output_dir ./output/huarizo-llama2-70b-2-chat-hf-orig \
    ...
    --lora_r 64 \
	--is_r_by_svd False \
	--rank_file "/workspace/asr/peft/qlora/llama2_70bchathf_lazylora_r64_2.json" \
    --lazy_lora_alpha 16 \
