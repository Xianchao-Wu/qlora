...
#3. mpath="/workspace/asr/peft/qlora/models--meta-llama--Llama-2-7b-hf/snapshots/7b98be05b7ae501a207aadd47370757a5fd0a3e7" # 0.4667698048601774
...
# TODO use this bash to learn again the lazy lora peft code with qlora - 2023-07-26 
...
do
	...
	out_dir="/workspace/asr/peft/qlora/output/huarizo-llama2-7b-2-hf"
	for checkpoint_dir in `ls -d ${out_dir}/checkpoint-100`
	do
		echo "----"
		echo ${checkpoint_dir}
		echo "----"
