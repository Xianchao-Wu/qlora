...
mpath="/workspace/asr/llama/models--meta-llama--Llama-2-13b-hf/snapshots/31820c723bc0368c339e067553021dc6a8bf4375"

python qlazylora.py \
    --model_name_or_path $mpath \
    --output_dir ./output/huarizo-llama2-13b-2-hf-orig \
