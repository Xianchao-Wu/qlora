...
mpath="/workspace/asr/peft/qlora/models--meta-llama--Llama-2-7b-hf/snapshots/4e4d531bcab430a66c4d562b7e89e21c0fa235ea"

python qlazylora.py \
    --model_name_or_path $mpath \
    --output_dir ./output/huarizo-llama2-7b-2-hf-orig \
