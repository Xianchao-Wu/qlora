...
mpath="/workspace/asr/llama/models--meta-llama--Llama-2-13b-chat-hf/snapshots/7389082e6bc4fcbf6202e6108a70194800e6c51e"
#--model_name_or_path meta-llama/Llama-2-13b-chat-hf \
python qlazylora.py \
    --model_name_or_path $mpath \
    --output_dir ./output/huarizo-llama2-13b-2-chat-hf-orig \
